...
create table if not exists tt_hc_adb_ws.gold.fact_transactions
(
...
truncate table tt_hc_adb_ws.gold.fact_transactions

-- COMMAND ----------

insert into tt_hc_adb_ws.gold.fact_transactions
select 
  t.TransactionID, 
  t.SRC_TransactionID,
  t.EncounterID,
  ...
  t.datasource,
  current_timestamp()
  from tt_hc_adb_ws.silver.transactions t 
