...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS tt_hc_adb_ws.silver.transactions (
...
# MAGIC MERGE INTO tt_hc_adb_ws.silver.transactions AS target USING quality_checks AS source ON target.TransactionID = source.TransactionID
