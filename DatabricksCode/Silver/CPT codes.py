...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS tt_hc_adb_ws.silver.cptcodes (
...
# MAGIC MERGE INTO tt_hc_adb_ws.silver.cptcodes AS target
...
# MAGIC %sql
# MAGIC select * from  tt_hc_adb_ws.silver.cptcodes
