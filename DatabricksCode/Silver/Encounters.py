...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS tt_hc_adb_ws.silver.encounters (
...
# MAGIC MERGE INTO tt_hc_adb_ws.silver.encounters AS target
...
# MAGIC MERGE INTO tt_hc_adb_ws.silver.encounters AS target USING quality_checks AS source ON target.EncounterID = source.EncounterID
...
# MAGIC %sql
# MAGIC select SRC_EncounterID,datasource,count(patientid) from  tt_hc_adb_ws.silver.encounters
# MAGIC group by all
