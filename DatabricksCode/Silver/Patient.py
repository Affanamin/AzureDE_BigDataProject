...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS tt_hc_adb_ws.silver.patients (
...
# MAGIC MERGE INTO tt_hc_adb_ws.silver.patients AS target
...
# MAGIC %sql
# MAGIC select count(*),Patient_Key from tt_hc_adb_ws.silver.patients
