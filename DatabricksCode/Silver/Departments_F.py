...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS tt_hc_adb_ws.silver.departments (
...
# MAGIC %sql
# MAGIC insert into tt_hc_adb_ws.silver.departments
# MAGIC SELECT 
# MAGIC Dept_Id,
# MAGIC SRC_Dept_Id,
# MAGIC Name,
...
# MAGIC %sql
# MAGIC select * from tt_hc_adb_ws.silver.departments
